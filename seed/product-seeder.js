...
db.once('open', function() {
    ...
    var products = [
        new Product({
            imagePath: 'images/hearthstone1.jpg',
            title: 'Hearthstone',
            description: 'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.',
            price: 0
        }),
        new Product({
            imagePath: 'images/751D461631E9293C9460EC52BE3A3736C9B89E61.jpg',
            title: 'World Of Warcraft - Region',
        ...
        new Product({
            imagePath: 'images/razer-overwatch-header-mobile.jpg',
            title: 'Overwatch',
        ...
        new Product({
            imagePath: 'images/og-sc2-legacy-of-the-void.jpg',
            title: 'StarCraft II: Legalcy of the Void',
        ...
        new Product({
            imagePath: 'images/social-facebook-heroes_2.jpg',
